...
public class MainFrame extends JFrame {
    ...
    private ImageIcon createProperIcon(String path) {
    ...
    public JMenuItem createMenuItem(String title, String tooltip, int mnemonic, String icon, String actionMethod) throws SecurityException, NoSuchMethodException {
        ...
        if (icon != null)
            item.setIcon(createProperIcon("src/main/resources/" + icon));
        final Class<? extends MainFrame> c = getClass();
        ...
        item.addActionListener(new MenuActionListener(menuBar,toolBar));
